...
# Defining the correction rotational matrix outside the loop to save computation time.
...
# NOTE: The above code was run once and the output is being used directly to save computation time.
...
def handle_calculate_IK(req):
    ...
    # Defining the R0_3_inv matrix used in calculating the last three angles outside the loop to save computation time.
    ...
    if len(req.poses) < 1:
        ...
        for x in xrange(0, len(req.poses)):
            ...
            # The correction matrix, R_corr_inv is already calculated.
            ...
            # So now we need R0_3.inv() and this has already been defined symbolically outside the loop as R0_3_inv_main.
            ...
            # The above result is being used to calculate the following:
